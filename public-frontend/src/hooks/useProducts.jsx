...
const useProducts = (options) => {
  const { page, category_id, brand, requires_installation, search } = options

  const productsQuery = useQuery({
    queryKey: ['products', { page, category_id, brand, requires_installation, search }],
    queryFn: () => getProducts({ page, category_id, brand, requires_installation, search }),
