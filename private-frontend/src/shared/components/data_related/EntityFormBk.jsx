...
const EntityFormBk = ({ onSubmit, apiRes, apiResType, controls = [], values, formId, isSuccess }) => {
  const [refresh, setRefresh] = useState(true)
  const { register, handleSubmit, formState, control, reset } = useForm({ values })
  ...
  const customOnSubmit = handleSubmit((data) => {
    onSubmit(data)
  ...
  return (
    <form id={formId} onSubmit={customOnSubmit}>
