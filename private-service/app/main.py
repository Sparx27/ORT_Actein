...
from app.router.rou_product import product_router
...
async def unauthorized_handler(request: Request, exc):
    return JSONResponse(status_code=401, content={'detail': 'No autorizado. Token ausente, inválido o expirado'})


@app.exception_handler(403)
async def forbidden_handler(request: Request, exc):
    return JSONResponse(status_code=403, content={'detail': 'No tienes permisos para realizar esta operación'})
